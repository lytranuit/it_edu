              ...
              <div class="col-md-4 login-sec">
                ...
                <form action="" method="post">
                  <div class="form-group">
                    <input class="form-control form-control-sm" id="username" name="login" type="text"
                      placeholder="Username" autocomplete="off" v-model="form.email">
                  </div>
                  <div class="form-group">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                      <img class="d-block img-fluid" src="/images/nhamay2.jpg" alt="First slide">
                    ...
                    <div class="carousel-item">
                      <img class="d-block img-fluid" src="/images/hinh-nha-may-hoang-van-thu.jpg" alt="First slide">
                      <div class="carousel-caption d-none d-md-block">
                        <div class="banner-text">
                        </div>
                      </div>
