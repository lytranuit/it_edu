...
namespace Vue
{
	public class Program
	{
		public static void Main(string[] args)
		{
			...
			var connectionStringEdu = builder.Configuration.GetConnectionString("EduConnection") ?? throw new InvalidOperationException("Connection string 'EduContextConnection' not found.");
			...
			builder.Services.AddDbContext<EduContext>(options =>
			  options.UseSqlServer(connectionStringEdu)
			  );
