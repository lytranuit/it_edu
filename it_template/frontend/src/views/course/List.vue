...
const deleteProduct = () => {
    waiting.value = true;
    axiosinstance.post("/v1/course/remove", { item: [model.value.id] }, {
        headers: {
            'Content-Type': 'multipart/form-data'
        }
    }).then((res) => {
...
const deleteSelectedProducts = () => {
    ...
    waiting.value = true;
    axiosinstance.post("/v1/course/remove", { item: item }, {
        headers: {
            'Content-Type': 'multipart/form-data'
        }
    }).then((res) => {
