                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group row">
                            <b class="col-12 col-lg-2 col-form-label">Tài khoản:</b>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-lg-10 pt-1">
                                <input name="email" placeholder="Email" class="form-control" readonly :value="user.email" />
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card no-shadow border">
                                    ...
                                    <div class="card-body text-center">
                                        <img style="max-height:100px;max-width: 100%;cursor:pointer;" :src="user.image_url"
                                            class="image_feature" />
                                    </div>
                                </div>
                            </div>
